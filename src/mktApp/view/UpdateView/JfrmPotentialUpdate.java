 ...
 * @author DIEGO
 */
public class JfrmPotentialUpdate extends javax.swing.JFrame {
     ...
     */
    public JfrmPotentialUpdate(String adviser_email_parameter, String email_to_change) {
        initComponents();
        ...
        potential = MainManager.getPotentialUserManager().searchPotential(email_to_change);
        ...
        jtxfCompanyName.setText(potential.getName_company());
        jtxfCallStatus.setText(potential.getCall_status());
        jtxfCustomerStatus.setText(potential.getCustomer_status());
    }
    ...
    private void initComponents() {
        ...
        jLabel16.setText("ACTUALIZACIÓN DE DATOS DE POTENCIAL CLIENTE");
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (jtxfMobile.getText().length() < 9 || jtxfMobile.getText().length() > 9) {
            ...
            /*} else if (potential.getEmail_adviser().trim().equals("") == true) {
                ...
                boolean status = MainManager.getPotentialUserManager().updatePotential(potential);
                if (status == true) {
