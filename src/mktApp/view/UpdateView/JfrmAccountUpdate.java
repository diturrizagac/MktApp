 ...
 * @author DIEGO
 */
public class JfrmAccountUpdate extends javax.swing.JFrame {
    String  adviser_email_parameter;
    Account account;
    /**
     * Creates new form JfrmAccountSignUp
     */
    public JfrmAccountUpdate(String adviser_email_parameter, String email_to_change) {
        initComponents();
        ...
        account = MainManager.getAccountUserManager().searchAccount(email_to_change);
        jtxfEmail.setText(account.getEmail());
        jtxfFirstName.setText(account.getFirst_name());
        jtxfLastName.setText(account.getLast_name());
        jtxfMobile.setText(account.getMobile());
        jtxfCompanyName.setText(account.getName_account());
        jtxfCombo.setText(account.getName_combo());
        jtxfPayMethod.setText(account.getPay_method());        
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if(jtxfMobile.getText().length() < 9 || jtxfMobile.getText().length() > 9){
            ...
            if (account.getEmail().trim().equals("") == true) {
                ...
                boolean status = MainManager.getAccountUserManager().updateAccount(account);
                if (status == true) {
